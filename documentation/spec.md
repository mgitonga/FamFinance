...
| **Utilities** | *(standalone — add sub-cats: Water, Electricity, Internet later)* | Expense |
| **Entertainment** | *(standalone)* | Expense |
...
| **Investment** | *(standalone)* | Expense |
| **Salary** | *(standalone)* | Income |
| **Side Income** | *(standalone)* | Income |
| **Other Income** | *(standalone)* | Income |
| **Other** | *(standalone)* | Both |
...
| Systems Analyst | GitHub Copilot | *Digital* | Feb 20, 2026 |
...
*FamFin Functional Specification v1.0 — Confidential*

*Prepared by GitHub Copilot (Systems Analyst) — February 20, 2026*
